...
class Handler(BaseHTTPRequestHandler):
    ...
    def _ote_vdt_fetch_day(self, day_dt):
        ...
        url = (f"https://www.ote-cr.cz/attachments/27/{day_dt.year}/"
    ...
    def _smard_residual_load(self, qs):
        ...
        try:
            ...
            # Vezmi POSLEDNI 2 timestampy (= 2 tydny, abychom meli aspon 1 tyden historie)
            last_timestamps = timestamps[-2:]
