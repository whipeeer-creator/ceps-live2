    ...
    def do_GET(self):
        ...
        if parsed.path == "/health":
            self._json({"status": "ok", "time": datetime.now().isoformat(),
                        "version": "regelleistung-xlsx-v15-nocache"}); return
        ...
        try:
            ...
            try:
                ...
                if r2.status_code == 200:
                    ...
                    # last_8h: 8 nedavnych hodin
                    # API neposkytuje hoursYesterday, takze:
                    #   - Kdyz current_hour >= 7: ukaz hodiny ch-7 az ch (poslednich 8 dnesnich)
                    #   - Kdyz current_hour < 7 (rano): ukaz hodiny 0-7 dnesniho dne
...
if __name__ == "__main__":
    ...
    print(f"VERSION: regelleistung-xlsx-v15-nocache", flush=True)
